...
<body class="login-page">
  ...
  <section class="login-box">
      ...
      <form id="login-form" action="login.php" method="post">
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="E-mail / N.º de Telefone" name="username">
          </div>
        </div>
        ...
        <button type="submit" id="login-btn" class="btn btn-success btn-block btn-flat" data-loading-text="Logando...">
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="http://langsberg.com">Langsberg.com</a>, v<?php echo settings('version'); ?></p>
    </div>
  </section>
        ...
        <div class="modal-content">
          <form action="#" method="post" accept-charset="utf-8">
            ...
            <div class="modal-body">
              ...
              <input id="email" type="email" name="email" placeholder="E-mail" autocomplete="off" class="form-control">
            </div>
            <div class="modal-footer">
              <button data-dismiss="modal" class="btn btn-warning pull-left" type="button"><?php echo trans('button_close'); ?></button>
              <button id="reset-btn" name="reset-btn" class="btn btn-success" type="submit" data-loading-text="Enviando E-mail...">
