...
<body class="lockscreen">
  ...
  <div class="lockscreen-wrapper">
    <h4 class="text-center text-green">PDV SUPER COMPLETO <small class="text-muted">v<?php echo settings('version'); ?></small></h4>
    <br>
    ...
    <div class="lockscreen-item">
      ...
      <form class="lockscreen-credentials" action="" method="post" autocomplete="off">
        <div class="input-group">
          <input class="form-control" type="password" name="password" placeholder="palavra-passe" autocomplete="off" autofocus>
    ...
    <div class="help-block text-center">
      Digite a sua palavra-passe para voltar a sua sessão
    </div>
    <div class="text-center">
      <a href="index.php" style="font-size:1.8rem;color:green;text-decoration:underline;"><small>ou</small> inicie a sessão com um usuário diferente</a>
    </div>
    <div class="lockscreen-footer text-center">
      <div class="copyright" style="font-size:1.2rem;">Copyright © <?php echo date('Y'); ?> <a href="http://dimalang.com">dimalang.com</a></div>
    </div>
  </div>
