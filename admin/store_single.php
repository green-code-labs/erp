							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<select name="preference[reference_format]" class="form-control tip" required="required" id=reference_format">
										<option value="year_sequence" <?php echo get_preference('reference_format') == 'year_sequence' ? 'selected' : null; ?>>ANO/Sequência do Número (SL/2025/001)</option>
										<option value="year_month_sequence" <?php echo get_preference('reference_format') == 'year_month_sequence' ? 'selected' : null; ?>>ANO/MÊS/Sequência do Número (SL/2025/09/001)</option>
										<option value="sequence" <?php echo get_preference('reference_format') == 'sequence' ? 'selected' : null; ?>>Sequência do Número</option>
										<option value="random" <?php echo get_preference('reference_format') == 'random' ? 'selected' : null; ?>>Número Aleatório</option>
									</select>
								</div>
							</div>
							<div class="form-group">
											...
											<div class="col-sm-6">
												...
												<div>
													<select class="form-control" name="auto_print" id="auto_print_receipt">
														<option value="1" <?php echo store('auto_print') == 1 ? 'selected' : null; ?>>Sim
														</option>
														<option value="0" <?php echo store('auto_print') == 0 ? 'selected' : null; ?>>Não
														</option>
													</select>
												</div>
											</div>
