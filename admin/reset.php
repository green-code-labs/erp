		...
		<div id="reset-form">
			<div class="container">
				<div class="container-inner">
					<h2 class="alert success">Redefinida com Sucesso!</h2>
				</div>
				<div class="buttons">
					<a class="btn back" href="<?php echo root_url(); ?>/admin/dashboard.php">&larr;Voltar ao Dashboard</a>
				</div>
			</div>
		</div>
	<?php else: ?>
		<form action="<?php echo root_url(); ?>/admin/reset.php?action=reset" method="POST">
			<div id="reset-form">
				<div class="container">
					...
					<div class="buttons">
						<button class="btn yes" type="submit">SIM</button>
						<a class="btn no" href="<?php echo root_url(); ?>/admin/dashboard.php">NÃO</a>
					</div>
				</div>
			</div>
		</form>
