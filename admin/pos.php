...
<head>
	...
	<style type="text/css">
		body::after {
			content: "";
			background: url(../assets/itsolution24/img/pos/patterns/<?php echo $user->getPreference('pos_pattern') ? $user->getPreference('pos_pattern') : 'armysuit.jpg'; ?>) repeat repeat;
			opacity: 0.4;
							...
							<div id="item-list">
								...
								<div ng-repeat="products in productArray" id="{{ $index }}" class="btn btn-flat item">
									<div ng-click="addItemToInvoice(products.p_id,products)" class="item-inner">
										...
										<span ng-show="products.p_type=='service'" class="ibadge">Serviço</span>
									</div>
								</div>
							...
							<div class="well well-sm">
								...
								<div id="pay-button" class="text-center">
									<div class="btn-group btn-group-justified">
										<div class="btn-group">
											<button ng-click="payNow()" onClick="return false;" class="btn btn-success" data-loading-text="Processando..." title="Pagamento">
												<span class="fa fa-fw fa-money"></span>
												<?php echo trans('button_pay'); ?>
											</button>
										</div>
										<div class="btn-group">
											<button ng-click="HoldingOrderModal()" on-click="return false;" class="btn btn-danger" data-loading-text="Processando..." title="Order Holdinbg">
