              ...
              <div class="well well-sm">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <select name="per_page" class="form-control" id="per_page">
                        ...
                        <option value="40" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 40 ? 'selected' : 'selected'; ?>>40 por página (a4) (1.799" x 1.003")</option>
                        <option value="30" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 30 ? 'selected' : null; ?>>30 por página (2.625" x 1")</option>
                        <option value="24" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 24 ? 'selected' : null; ?>>24 por página (a4) (2.48" x 1.334")</option>
                        <option value="20" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 20 ? 'selected' : null; ?>>20 por página (4" x 1")</option>
                        <option value="18" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 18 ? 'selected' : null; ?>>18 por página (a4) (2.5" x 1.835")</option>
                        <option value="14" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 14 ? 'selected' : null; ?>>14 por página (4" x 1.33")</option>
                        <option value="12"
                          <?php if (isset($request->post['per_page']) && $request->post['per_page'] == 12) {
                            echo 'selected';
                          }; ?>>12 por página (a4) (2.5" x 2.834")</option>
                        <option value="10" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 10 ? 'selected' : null; ?>>10 por página (4" x 2")</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group mb-0">
                ...
                <div class="form-group">
                  <div class="col-sm-3 col-sm-offset-3 text-center">
                    <button id="barcode-generate" class="btn btn-info btn-block" data-form="#form-barcode-generate" name="submit" data-loading-text="Gerando...">
            ...
            <div id="barcode-con">
              ...
              ?>
                ...
                <div class="barcode barcode<?php echo $page_layout; ?>">
                  <?php $inc = 1;
                  foreach ($request->post['products'] as $prod): $product = get_the_product($prod['item_id']);
                        ...
                        <div class="item-inner">
                          ...
                          <?php if (isset($request->post['fields']['site_name']) && $request->post['fields']['site_name']): ?>
                            <div style="margin-bottom:2px;">
                              <span style="font-size:12px;" class="barcode_site"><?php echo store('name'); ?></span>
                            </div>
                          <?php endif; ?>
                          <?php if (isset($request->post['fields']['product_name']) && $request->post['fields']['product_name']): ?>
                            <div style="line-height:1.222;font-weight:700;">
                              <span style="font-size:10px;" class="barcode_name"><?php echo $product['p_name']; ?></span>
                            </div>
                          <?php endif; ?>
                          <?php if (isset($request->post['fields']['unit']) && $request->post['fields']['unit']): ?>
                          ...
                          <?php if (isset($request->post['fields']['price']) && $request->post['fields']['price']): ?>
                            <div style="font-size:15px;line-height:1.222;font-weight:700;">
                              ...
                              <?php endif; ?>
                              <?php echo currency_format($product['sell_price']); ?></span>
                            </div>
                          <?php endif; ?>
