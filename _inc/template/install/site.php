...
<div class="container">
		...
		<div class="col-sm-8 col-sm-offset-2">
			<div class="panel panel-default menubar">
				...
				<div class="panel-body ins-bg-col">
					<form id="siteForm" class="form-horizontal" action="site.php" method="post">
						...
						<label for="store_name" class="col-sm-3 control-label">
							<p>Nome <span class="text-aqua">*</span></p>
						</label>
						<div class="col-sm-8">
				...
				<label for="phone" class="col-sm-3 control-label">
					<p>Telefone <span class="text-aqua">*</span></p>
				</label>
				<div class="col-sm-8">
	...
	<label for="address" class="col-sm-3 control-label">
		<p>Address <span class="text-aqua">*</span></p>
		</p>
	</label>
	<div class="col-sm-8">
...
<div class="text-center copyright">&copy; <a href="http://dimalang.com">dimalang.com</a>, All right reserved.</div>
</div>
</div>
</div>